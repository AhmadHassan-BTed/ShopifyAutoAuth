...
Thank you for using `shopify_auth_adapter`! Here are the recommended channels for getting help.
...
- [docs/system-design.md](docs/system-design.md) – Technical breakdown of token caching and lifecycle.
- [docs/security-architecture.md](docs/security-architecture.md) – Security model and credential handling.
